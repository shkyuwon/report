...
USAGE
report  <newick tree file path> <output file path> <outgroup species list separated with a blank>
...
report sample1.tre result.txt H.vulgare B.distachyon
(Linux)
mono report sample1.tre result.txt H.vulgare B.distachyon
